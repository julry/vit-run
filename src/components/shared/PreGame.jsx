...
const RULES_TEXTS = {
    ...
    3: <>
        <b>Собирай предметы</b>, их количество влияет на твой рейтинг.
    </>,
    4: <>
        <b>Не пропускай вопросы</b>, за правильные ответы после игры ты будешь получать Виткоины.
    </>,
    5: <>
        Виткоины влияют на твоё положение в рейтинге. Здесь <b>конвертируются собранные предметы и правильные ответы</b>.
    </>
}
