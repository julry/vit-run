...
export const questionsLevel2 = [ 
    ...
    {
        id: 6,
        text: 'Новый сотрудник предприятия Саша, очень хочет побыстрее стать Лидером гостеприимства. Его наставник порекомендовал  действия, которые помогут ему развить эмпатию, чтобы лучше понимать потребности гостей в новой роли. Какие это действия?',
        answers: [
            {
                id: 4,
    ...
    {
        id: 10,
        text: 'Света, директор предприятия, впервые собирается выступать на собрании директоров. Но она очень волнуется: в голову постоянно лезут неприятные мысли: «У меня не получится, я точно не справлюсь». Как ей стоит поступить? Выбери все варианты, которые считаешь правильными.',
        answers: [
            {
                id: 1,
